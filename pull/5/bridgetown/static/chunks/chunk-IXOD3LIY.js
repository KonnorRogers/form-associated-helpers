import{a as le,b as ue,c as ce}from"/form-associated-helpers/pull/5/bridgetown/static/chunks/chunk-44Y375VS.js";import{a as T,d as O,f as oe,g as ee,i as se}from"/form-associated-helpers/pull/5/bridgetown/static/chunks/chunk-LKE63TLK.js";import{a as ge}from"/form-associated-helpers/pull/5/bridgetown/static/chunks/chunk-LJIOZX45.js";import{d as B}from"/form-associated-helpers/pull/5/bridgetown/static/chunks/chunk-WQOWVNO2.js";var I=class extends ge(se){constructor(){super(),Object.entries(this.constructor.dependencies).forEach(([t,n])=>{n.define(t)})}};B(I,"dependencies",{});var de=T`
*, *:after, *:before {
...
`;var Me=/\r\n|\r|\n/;function $e(e={}){let t=e.disableLineNumbers??!1,n=e.lineNumberStart??1;return function(a){let i=[];Te(a.tokens).forEach((o,c)=>{o.length<=0&&o.push(" "),e.disableLineNumbers!==!0&&i.push(new S("light-gutter-cell",(c+n).toString())),i.push(new S("light-line",o))}),a.tokens=i}}function Ge(e){return Array.isArray(e)?e:[e]}function Oe(e){return e.length===0?"":e.length===1&&typeof e[0]=="string"?e[0]:e}function Te(e){let t=[],n=[t];for(let r=0;r<e.length;r++){let a=e[r];if(typeof a=="string"){let i=a.split(Me);for(let o=0;o<i.length;o++){o>0&&n.push(t=[]);let c=i[o];c&&t.push(c)}}else{let i=Te(Ge(a.content));if(i.length>1)for(let o=0;o<i.length;o++){o>0&&n.push(t=[]);let c=i[o];if(c.length){let g=new S(a.type,Oe(c),a.alias);g.length=c.reduce((l,s)=>l+s.length,0),t.push(g)}}else t.push(a)}}return n}var j=class{constructor(){let t=()=>{this.errors=[],this.ranges=[],this.numbers=new Set};this.reset=t,this.reset()}includes(t){if(this.numbers.has(t))return!0;if(this.ranges.length==0)return!1;for(let n of this.ranges){let[r,a]=n;if(t>=r&&t<=a)return!0}return!1}parse(t){return this.reset(),t.includes("{")?t.includes("}")?(t=t.split(/{/)[1],t?(t=t.split(/}/)[0],t.split(/,\s*/).forEach(n=>{let[r,a]=n.split(/-/),i=Number(r),o=Number(a);if(!(i==null||isNaN(i))){if(o==null||isNaN(o)){this.numbers.add(i);return}this.ranges.push([i,o])}}),this):(this.errors.push(new Error("Invalid string provided for range.")),this)):(this.errors.push(new Error("Unable to parse range. No `}` found.")),this):(this.errors.push(new Error("Unable to parse range. No `{` found.")),this)}};function je(e){let{highlightLinesRange:t,insertedLinesRange:n,deletedLinesRange:r}=e;return function(a){let i=1;for(let o of a.tokens)typeof o!="string"&&(t.includes(i)&&(o.type+=" line-highlight"),n.includes(i)&&(o.type+=" inserted"),r.includes(i)&&(o.type+=" deleted"),o.type.includes("light-line")&&i++)}}function Be(){return function(e){let t=["inserted","line-highlight","deleted"];e.type.includes("light-line")&&(e.attributes.part="line",t.forEach(n=>{e.type.includes(n)&&(n==="line-highlight"&&(n="highlight"),e.attributes.part+=" line-"+n)})),e.type.includes("light-gutter-cell")&&(e.attributes.part="gutter-cell",t.forEach(n=>{e.type.includes("gutter-cell-"+n)&&(n==="line-highlight"&&(n="highlight"),e.attributes.part+=" gutter-cell-"+n)}))}}var N=class extends I{constructor(){super(),this.language="html",this.disableHighlight=!1,this.code="",this.__mutationObserverConfig={childList:!0,subtree:!0,characterData:!0},this.codeDebounce=Le(()=>this.handleMutation("code"),20),this.wrap="soft",this.preserveWhitespace=!1,this.highlightLines="",this.insertedLines="",this.deletedLines="",this.disableLineNumbers=!1,this.lineNumberStart=1,this.highlighter=K(),this.__resizeObserver=new ResizeObserver(()=>this.__setGutterMeasurements()),this.__highlightedCode__=""}connectedCallback(){super.connectedCallback(),this.__resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.__resizeObserver.unobserve(this)}willUpdate(t){(t.has("highlighter")||t.has("language")||t.has("code"))&&(this.__highlightedCode__=this.highlight(this.code)),super.willUpdate(t)}updated(t){if((t.has("insertedLines")||t.has("deletedLines")||t.has("highlightLines"))&&!t.has("code")){let n=this.shadowRoot?.querySelectorAll(".light-gutter-cell, .light-line");if(n?.length){let r=new j().parse(this.highlightLines),a=new j().parse(this.insertedLines),i=new j().parse(this.deletedLines);n.forEach((o,c)=>{let l=(c%2===0?c:c-1)/2+1;o.classList.toggle("line-highlight",r.includes(l)),o.part.toggle("line-highlight",r.includes(l)),o.classList.toggle("inserted",a.includes(l)),o.part.toggle("inserted",a.includes(l)),o.classList.toggle("deleted",i.includes(l)),o.part.toggle("deleted",i.includes(l))})}}super.updated(t)}handleMutation(t){if(t==="code"){this.handleTemplate({target:this.findSlot("code")});return}}findSlot(t){return this.shadowRoot?.querySelector(`slot[name='${t}']`)}handleTemplate(t){let n=t.target;if(n==null)return;let r=n.getAttribute("name");if(["preview-code","code"].includes(r||"")===!1)return;let a=n.assignedElements({flatten:!0}),i=this.unescapeTags(fe(...a));if(this.preserveWhitespace||(i=he(i.trim())),r==="code"){this.code=i;return}}unescapeTags(t){return t.replaceAll(/&lt;\/([\w\d\.-_]+)>/g,"</$1>")}highlight(t=this.code){this.highlighter||(this.highlighter=K());let n=[$e({lineNumberStart:this.lineNumberStart,disableLineNumbers:this.disableLineNumbers}),je({insertedLinesRange:new j().parse(this.insertedLines),deletedLinesRange:new j().parse(this.deletedLines),highlightLinesRange:new j().parse(this.highlightLines)})];return this.highlighter.hooks.add("wrap",Be()),t=Se(t,this.highlighter.languages[this.language],this.language,this.highlighter,{afterTokenize:n}),t}__setGutterMeasurements(){let t=this.shadowRoot?.querySelector("[part~='gutter-cell']")?.offsetWidth;t&&this.style.setProperty("--gutter-cell-width",`${t}px`);let n=this.shadowRoot?.querySelector("[part~='code']");if(n){let{offsetHeight:r,clientHeight:a}=n,i=r-a;this.style.setProperty("--scrollbar-height",`${i}px`)}}render(){let t=this.language,n=O`
      <div part="base">
        ${ae(!this.disableHighlight,()=>O`
            ...
            ><code
              ...
              ></code></pre>`,()=>O`${_e(this.code)}`)}
        <!-- This gutter is for showing when line numbers may not correspond to existing lines. -->
        ${ae(this.disableLineNumbers,()=>O``,()=>O`<div part="gutter"></div>`)}
      </div>

      <div hidden>
        <slot name="code" @slotchange=${this.handleTemplate}></slot>
      </div>
    `;return setTimeout(async()=>{await this.updateComplete,setTimeout(()=>this.__setGutterMeasurements())}),n}};B(N,"baseName","light-code"),B(N,"styles",[de,Ee,pe,T`
      :host {
	display: grid;
      }
      [part~="base"] {
    ...
    `]),B(N,"properties",{summary:{},disableHighlight:{type:Boolean,attribute:"disable-highlight"},preserveWhitespace:{type:Boolean,attribute:"preserveWhitespace"},highlightLines:{attribute:"highlight-lines"},insertedLines:{attribute:"inserted-lines"},deletedLines:{attribute:"deleted-lines"},disableLineNumbers:{type:Boolean,reflect:!0,attribute:"disable-line-numbers"},lineNumberStart:{type:Number,attribute:"line-number-start"},wrap:{reflect:!0,attribute:"wrap"},language:{},code:{},highlighter:{attribute:!1,state:!0},__highlightedCode__:{attribute:!1,state:!0}});export{I as a,de as b,Ze as c,pe as d,he as e,fe as f,K as g,ae as h,Le as i,N as j};
...
lit-html/directives/unsafe-html.js:
   ...
   *)
*/
//# sourceMappingURL=/form-associated-helpers/pull/5/bridgetown/static/chunks/chunk-IXOD3LIY.js.map
