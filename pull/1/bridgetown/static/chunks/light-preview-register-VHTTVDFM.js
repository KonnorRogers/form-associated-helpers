import{a as u,b as $,c as M,d as k}from"/form-associated-helpers/pull/1/bridgetown/static/chunks/chunk-UZ6H6SB2.js";import{a as f,b,c as w,d as v,e as y,f as x,h as z,i as C}from"/form-associated-helpers/pull/1/bridgetown/static/chunks/chunk-NWWBFL7N.js";import{a as h}from"/form-associated-helpers/pull/1/bridgetown/static/chunks/chunk-PN4K5M5I.js";import{d as p}from"/form-associated-helpers/pull/1/bridgetown/static/chunks/chunk-5S3NTMW5.js";import{a as g,c as l}from"/form-associated-helpers/pull/1/bridgetown/static/chunks/chunk-CPCUEDBY.js";import{d as s}from"/form-associated-helpers/pull/1/bridgetown/static/chunks/chunk-RIJORYKN.js";var O=`
  allow-forms
  allow-modals
  allow-pointer-lock
  allow-popups
...
`;function R(d,e=" "){let t=[];for(let[r,o]of Object.entries(d))o&&t.push(r);return t.join(e)}function m(d,e=0){let t=null;return(...r)=>{t&&window.clearTimeout(t),t=window.setTimeout(()=>{d.apply(null,r)},e)}}var T="Show source code",i=class extends f{constructor(){super(),this.sandboxSettings=O,this.summary=T,this.language="html",this.previewMode="iframe",this.resizing=!1,this.disableHighlight=!1,this.code="",this.previewCode="",this.open=!1,this.resizePosition=100,this.resizeObserver=new ResizeObserver(e=>this.handleResize(e)),this.__mutationObserverConfig={childList:!0,subtree:!0,characterData:!0},this.previewCodeDebounce=m(()=>this.handleMutation("preview-code"),20),this.codeDebounce=m(()=>this.handleMutation("code"),20)}resetIframeCodeMutationObserver(){this.previewCodeMutationObserver&&this.previewCodeMutationObserver.disconnect(),this.previewCodeMutationObserver=new MutationObserver((...t)=>this.previewCodeDebounce());let e=this.findSlot("preview-code")?.assignedElements({flatten:!0})||[];for(let t of e)this.previewCodeMutationObserver.observe(t,this.__mutationObserverConfig)}resetCodeMutationObserver(){this.codeMutationObserver&&this.codeMutationObserver.disconnect(),this.codeMutationObserver=new MutationObserver((...t)=>this.codeDebounce());let e=this.findSlot("code")?.assignedElements({flatten:!0})||[];for(let t of e)this.codeMutationObserver.observe(t,this.__mutationObserverConfig)}handleMutation(e){if(e==="preview-code"){this.handleTemplate({target:this.findSlot("preview-code")});return}if(e==="code"){this.handleTemplate({target:this.findSlot("code")});return}}findSlot(e){return this.shadowRoot?.querySelector(`slot[name='${e}']`)}handleTemplate(e){let t=e.target;if(t==null)return;let r=t.getAttribute("name");if(["preview-code","code"].includes(r||"")===!1)return;let o="type"in e&&e.type==="slotchange",n=t.assignedElements({flatten:!0}),c=y(this.unescapeTags(x(...n)).trim());if(r==="preview-code"){o&&this.resetIframeCodeMutationObserver(),this.previewCode=c;return}if(r==="code"){o&&this.resetCodeMutationObserver(),this.code=c;return}}updateIframeContent(){let e=this.previewCode||this.code,t=this.shadowRoot?.querySelector("iframe");if(!t)return;let r=`
          ...
          <div part="code-wrapper">
            ${h(!this.disableHighlight,()=>l`
                ...
                ><code
                    part="code code-${e}"
                    class="language-${e}"
                  >${p(this.highlight())}</code></pre>`,()=>l`${p(this.code)}`)}
          </div>
        </light-disclosure>
    ...
    `}get panelResizer(){return this.shadowRoot?.querySelector("[part~='panel-resizer']")}handleDrag(e){e.cancelable&&e.preventDefault();let t=this.shadowRoot?.querySelector("iframe");t&&(t.style.pointerEvents="none"),this.resizing=!0;let o=(e.currentTarget?.offsetWidth||0)/2;$(this,{onMove:(n,c)=>{let D=n+o;this.resizePosition=u(0,this.pixelsToPercentage(D),100),this.updateResizePosition(),this.resizing=!0},onStop:()=>{let n=this.shadowRoot?.querySelector("iframe");n&&(n.style.pointerEvents="auto"),this.resizing=!1},initialEvent:e})}updateResizePosition(e=this.resizePosition){let t=e;if(t!=null){let r=100-t;this.style.setProperty("--start-panel-width",`clamp(100px, ${t}%, 100%)`),this.style.setProperty("--end-panel-width",`${r}%`)}}handleResizerKeydown(e){if(["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key)){let t=this.resizePosition,r=(e.shiftKey?10:1)*1;e.preventDefault(),e.key==="ArrowLeft"&&(t-=r),e.key==="ArrowRight"&&(t+=r),e.key==="Home"&&(t=100),e.key==="End"&&(t=0),this.resizePosition=u(0,t,100)}}pixelsToPercentage(e){return e/this.cachedWidth*100}};s(i,"baseName","light-preview-base"),s(i,"dependencies",{"light-disclosure":k}),s(i,"styles",[b,w,S]),s(i,"properties",{summary:{},sandboxSettings:{reflect:!0,attribute:"sandbox-settings"},previewMode:{reflect:!0,attribute:"preview-mode"},disableHighlight:{type:Boolean,attribute:"disable-highlight"},open:{reflect:!0,type:Boolean},resizePosition:{reflect:!0,type:Number,attribute:"resize-position"},resizing:{reflect:!0,type:Boolean},language:{},code:{attribute:!1},previewCode:{attribute:!1}});var a=class extends i{highlight(e=this.code){return C(e,z.languages[this.language],this.language)}};s(a,"baseName","light-preview"),s(a,"styles",i.styles.concat([v]));var ae=a;a.define();export{ae as default};
//# sourceMappingURL=/form-associated-helpers/pull/1/bridgetown/static/chunks/light-preview-register-VHTTVDFM.js.map
