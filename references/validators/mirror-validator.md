...
<main id="main" class="documentation-content flow">
  <h1 id="mirror-validator">
    <a href="#mirror-validator">
      Mirror Validator
    </a>
  </h1>
    ...
    <div class="pagination-footer">
      ...
      <sl-button class="previous-page" href="/form-associated-helpers/references/mixins/lit-form-associated-mixin/">
        <span slot="prefix">
        ...
        <span style="text-align: end; display: block;">
          ...
          <pagination-title>Lit Form Associated Mixin</pagination-title>
        </span>

      </sl-button>

      <sl-button class="next-page" href="/form-associated-helpers/references/validators/pattern-mismatch-validator.md">
...
<nav slot="aside" class="table-of-contents" id="table-of-contents" aria-label="Table of contents" tabindex="-1" data-controller="scroll-spy">
  ...
  <div class="footer">
    ...
    <a href="https://github.com/konnorrogers/form-associated-helpers/tree/main/docs/src/_documentation/references/validators/mirror-validator.md"> Edit this page on GitHub </a>
