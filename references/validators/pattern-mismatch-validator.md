...
<title>Pattern Mismatch Validator</title>
...
<main id="main" class="documentation-content flow">
  <h1 id="pattern-mismatch-validator">
    <a href="#pattern-mismatch-validator">
      Pattern Mismatch Validator
    </a>
  </h1>
    ...
    <div class="pagination-footer">
      ...
      <sl-button class="previous-page" href="/form-associated-helpers/references/validators/mirror-validator.md">
        <span slot="prefix">
        ...
        <span style="text-align: end; display: block;">
          ...
          <pagination-title>Mirror Validator</pagination-title>
        </span>

      </sl-button>

      <sl-button class="next-page" href="/form-associated-helpers/references/validators/range-overflow-validator.md">
...
<nav slot="aside" class="table-of-contents" id="table-of-contents" aria-label="Table of contents" tabindex="-1" data-controller="scroll-spy">
  ...
  <div class="footer">
    ...
    <a href="https://github.com/konnorrogers/form-associated-helpers/tree/main/docs/src/_documentation/references/validators/pattern-mismatch-validator.md"> Edit this page on GitHub </a>
